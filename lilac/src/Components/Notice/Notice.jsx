...
const Notice = () => {
  return (
    <div className='d-flex bg-primary align-items-center justify-content-center mt-5 ' style={{height:"285px",color:"white"}} >
  ...
  <input type="text" class="form-control p-2" style={{width:"400px"}} placeholder="Enter Your Email" aria-label="" aria-describedby="basic-addon2" />
